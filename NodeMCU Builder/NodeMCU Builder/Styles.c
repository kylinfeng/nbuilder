...
EDITLEXER lexDefault = { SCLEX_NULL, 63000, L"Default Text", L"txt; text; wtx; log; asc; doc; diz; nfo", L"", &KeyWords_NULL, {
                /*  0 */ { STYLE_DEFAULT, 63100, L"Default Style", L"font:Courier New; size:12", L"" },
                ...
                /* 11 */ { SCI_SETEXTRAASCENT+SCI_SETEXTRADESCENT, 63111, L"Extra Line Spacing (Size)", L"size:1", L"" },
...
//Basic functions
"assert collectgarbage dofile error gcinfo getfenv getmetatable loadfile load loadstring next pcall print rawequal rawget rawset select setfenv setmetatable tonumber tostring type unpack xpcall",
//Library functions
"adc.read adc.readvdd33 "
...
EDITLEXER lexLUA = { SCLEX_LUA, 63001, L"Lua Source Code", L"lua", L"", &KeyWords_LUA, {
                      { SCE_LUA_DEFAULT, 63126, L"Default", L"", L"" },
                      { MULTI_STYLE(SCE_LUA_COMMENTLINE,SCE_LUA_COMMENT,SCE_LUA_COMMENTDOC,0), 63127, L"Comment", L"italic; fore:#008000", L"" },
                      { SCE_LUA_WORD, 63128, L"Keyword", L"bold; fore:#0000FF", L"" },
                      { SCE_LUA_IDENTIFIER, 63129, L"Identifier", L"", L"" },
                      { MULTI_STYLE(SCE_LUA_STRING,SCE_LUA_CHARACTER,SCE_LUA_LITERALSTRING,SCE_LUA_STRINGEOL), 63131, L"String", L"fore:#000080", L"" },
                      { SCE_LUA_NUMBER, 63130, L"Number", L"fore:#FF0000", L"" },
                      { SCE_LUA_OPERATOR, 63132, L"Operator", L"fore:#B000B0", L"" },
                      { SCE_LUA_PREPROCESSOR, 63128, L"Preprocessor", L"fore:#FF8000", L"" },
                      { SCE_LUA_WORD2, 63136, L"Basic Functions", L"bold; fore:#000000", L"" },
                      { SCE_LUA_WORD3, 63137, L"Library Functions", L"bold; fore:#404080", L"" },
                      { SCE_LUA_WORD4, 63138, L"Constants", L"bold; fore:#C04040", L"" },
                      { -1, 00000, L"", L"", L"" } } };
